...
<head>
    ...
    <title>Description du jeux Base Militaire</title>
...
<body>
    ...
    <tr class="menu">
        ...
        <tr>
            <td colspan="5">
                <div class="container">
                    <h1>Escape Game Avion</h1>
                    <p>
                        Bienvenue dans notre escape game Base Militaire! Dans cet escape game palpitant, vous etes coinces dans une base militaire. Votre mission consiste à résoudre une série d'énigmes complexes pour éviter une catastrophe en plein vol!
                    </p>
                    <h2>Informations sur l'escape game :</h2>
                    <ul>
                        <li><strong>Durée :</strong> 60 minutes</li>
                        <li><strong>Niveau de difficulté :</strong> Moyen</li>
                        <li><strong>Nombre de joueurs :</strong> 2-6 joueurs</li>
